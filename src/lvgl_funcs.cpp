...
const lvTemperatureBundle temperatureBundles[NUMBER_OF_MOTORS] = {
    {lv_bar_create(parent, NULL), lv_label_create(parent, NULL), lv_label_create(parent, NULL), "FL", &frontleft},
    {lv_bar_create(parent, NULL), lv_label_create(parent, NULL), lv_label_create(parent, NULL), "ML", &midleft},
    {lv_bar_create(parent, NULL), lv_label_create(parent, NULL), lv_label_create(parent, NULL), "BL", &backleft},
    {lv_bar_create(parent, NULL), lv_label_create(parent, NULL), lv_label_create(parent, NULL), "FR", &frontright},
    {lv_bar_create(parent, NULL), lv_label_create(parent, NULL), lv_label_create(parent, NULL), "MR", &midright},
    {lv_bar_create(parent, NULL), lv_label_create(parent, NULL), lv_label_create(parent, NULL), "BR", &backright},
    {lv_bar_create(parent, NULL), lv_label_create(parent, NULL), lv_label_create(parent, NULL), "I", &intake},
    {lv_bar_create(parent, NULL), lv_label_create(parent, NULL), lv_label_create(parent, NULL), "H", &hang}
};
